    ...
    public async Task TriggerCampaign_WithAttachments_SerializesCorrectly()
    {
        ...
        var request = new TriggeredCampaign
        {
            ...
            Attachments = new List<Attachment>
            {
                ...
                {
                    FileName = "Invoice",
                    Url = new Uri("https://example.com/invoice.pdf")
                },
                new Attachment
                {
                    FileName = "Receipt",
                    Url = new Uri("https://example.com/receipt.jpg")
                }
            }
        };
        ...
        HttpRequestAssertions.AssertJsonProperty(attachments[0], "file_name", "Invoice");
        HttpRequestAssertions.AssertJsonProperty(attachments[0], "url", "https://example.com/invoice.pdf");

        HttpRequestAssertions.AssertJsonProperty(attachments[1], "file_name", "Receipt");
        HttpRequestAssertions.AssertJsonProperty(attachments[1], "url", "https://example.com/receipt.jpg");
    }
